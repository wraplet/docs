...
Does it look like a Web Component to you? That's a great observation! To see the direct comparison, see the [Wraplet vs Web Components](/blog/wraplet-vs-web-components) blog post.

If you're looking for a more general rationale, you may take a look at [Front-end, regrounded: Why Wraplet might be what you’re missing](/blog/why-wraplet) blog post.
