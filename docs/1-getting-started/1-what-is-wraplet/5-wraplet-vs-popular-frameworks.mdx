...
| Technology | Core philosophy | Where Wraplet stands out |
| --- | --- | --- |
...
| Web Components | Custom elements and shadow DOM | Declarative dependency management with async lifecycle, decoupled from the element one, spanning across the deep dependency trees. |
...
## Wraplet vs Stimulus, Alpine.js and Web Components
...
Here is a blog post specifically comparing Wraplet with Web Components: [Wraplet vs Web Components](/blog/wraplet-vs-web-components).
